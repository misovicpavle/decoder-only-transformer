...
How to run
    ...
    Open either notebook in Colab or local Jupyter.
    Put training-data-expanded_3.txt in the working directory.
    Run all cells in order.
    Optional: Resume from model_checkpoint.pt if available.
    Use the generation cell and test prompts interactively.
